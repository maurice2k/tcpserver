...
test_http_server() {
    ...
    do
        ...
        used_cpus+=($i)
        #result=`GOGC=400 numactl -N1 $bombardier -c $conns -d ${duration}s -pr -oj --fasthttp $3 |$jq . |tee /dev/fd/2 |$jq '.|select(.result.others==0) .result.rps.mean//0'`
        result=`GOGC=400 numactl -N1 $bombardier -c $conns -d ${duration}s -pr -oj --fasthttp $3 |$jq '.|select(.result.others==0) .result.rps.mean//0'`
...
run_test1() {
    ...
    test_http_server 'net-http-server/main.go' '-keepalive=0 -listen=127.0.0.10:8080 -aaaa=1024 -sleep=0' 'http://127.0.0.10:8080/'
    results_net=("${results[@]}")
    echo ""

    test_http_server 'evio-http-server/main.go' '-keepalive=0 -listen=127.0.0.11:8080 -aaaa=1024 -sleep=0 -loops=-1' 'http://127.0.0.11:8080/'
    results_evio=("${results[@]}")
    echo ""

    test_http_server 'gnet-http-server/main.go' '-keepalive=0 -listen=127.0.0.12:8080 -aaaa=1024 -sleep=0 -loops=-1' 'http://127.0.0.12:8080/'
    results_gnet=("${results[@]}")
    echo ""

    test_http_server 'fasthttp-http-server/main.go' '-keepalive=0 -listen=127.0.0.13:8080 -aaaa=1024 -sleep=0' 'http://127.0.0.13:8080/'
    results_fasthttp=("${results[@]}")
    echo ""

    test_http_server '../examples/http-server/main.go' '-keepalive=0 -listen=127.0.0.14:8080 -aaaa=1024 -sleep=0' 'http://127.0.0.14:8080/'
...
run_test2() {
    ...
    test_http_server 'net-http-server/main.go' '-keepalive=1 -listen=127.0.0.20:8080 -aaaa=1024 -sleep=0' 'http://127.0.0.20:8080/'
    results_net=("${results[@]}")
    echo ""

    test_http_server 'evio-http-server/main.go' '-keepalive=1 -listen=127.0.0.21:8080 -aaaa=1024 -sleep=0 -loops=-1' 'http://127.0.0.21:8080/'
    results_evio=("${results[@]}")
    echo ""

    test_http_server 'gnet-http-server/main.go' '-keepalive=1 -listen=127.0.0.22:8080 -aaaa=1024 -sleep=0 -loops=-1' 'http://127.0.0.22:8080/'
    results_gnet=("${results[@]}")
    echo ""

    test_http_server 'fasthttp-http-server/main.go' '-keepalive=1 -listen=127.0.0.23:8080 -aaaa=1024 -sleep=0' 'http://127.0.0.23:8080/'
    results_fasthttp=("${results[@]}")
    echo ""

    test_http_server '../examples/http-server/main.go' '-keepalive=1 -listen=127.0.0.24:8080 -aaaa=1024 -sleep=0' 'http://127.0.0.24:8080/'
    results_tcpserver=("${results[@]}")
    echo ""
...
run_test3() {
    ...
    test_http_server 'net-http-server/main.go' '-keepalive=0 -listen=127.0.0.30:8080 -aaaa=1024 -aes128 -sleep=0' 'http://127.0.0.30:8080/'
    results_net=("${results[@]}")
    echo ""

    test_http_server 'evio-http-server/main.go' '-keepalive=0 -listen=127.0.0.31:8080 -aaaa=1024 -aes128 -sleep=0 -loops=-1' 'http://127.0.0.31:8080/'
    results_evio=("${results[@]}")
    echo ""

    test_http_server 'gnet-http-server/main.go' '-keepalive=0 -listen=127.0.0.32:8080 -aaaa=1024 -aes128 -sleep=0 -loops=-1' 'http://127.0.0.32:8080/'
    results_gnet=("${results[@]}")
    echo ""

    test_http_server 'fasthttp-http-server/main.go' '-keepalive=0 -listen=127.0.0.33:8080 -aaaa=1024 -aes128 -sleep=0' 'http://127.0.0.33:8080/'
    results_fasthttp=("${results[@]}")
    echo ""

    test_http_server '../examples/http-server/main.go' '-keepalive=0 -listen=127.0.0.34:8080 -aaaa=1024 -aes128 -sleep=0' 'http://127.0.0.34:8080/'
    results_tcpserver=("${results[@]}")
    echo ""
...
run_test4() {
    ...
    test_http_server 'net-http-server/main.go' '-keepalive=1 -listen=127.0.0.40:8080 -aaaa=1024 -aes128 -sleep=0' 'http://127.0.0.40:8080/'
    results_net=("${results[@]}")
    echo ""

    test_http_server 'evio-http-server/main.go' '-keepalive=1 -listen=127.0.0.41:8080 -aaaa=1024 -aes128 -sleep=0 -loops=-1' 'http://127.0.0.41:8080/'
    results_evio=("${results[@]}")
    echo ""

    test_http_server 'gnet-http-server/main.go' '-keepalive=1 -listen=127.0.0.42:8080 -aaaa=1024 -aes128 -sleep=0 -loops=-1' 'http://127.0.0.42:8080/'
    results_gnet=("${results[@]}")
    echo ""

    test_http_server 'fasthttp-http-server/main.go' '-keepalive=1 -listen=127.0.0.43:8080 -aaaa=1024 -aes128 -sleep=0' 'http://127.0.0.43:8080/'
    results_fasthttp=("${results[@]}")
    echo ""

    test_http_server '../examples/http-server/main.go' '-keepalive=1 -listen=127.0.0.44:8080 -aaaa=1024 -aes128 -sleep=0' 'http://127.0.0.44:8080/'
    results_tcpserver=("${results[@]}")
    echo ""
...
run_install() {
    ...
    source ~/.profile
    sudo wget https://github.com/codesenberg/bombardier/releases/download/v1.2.4/bombardier-linux-amd64 ; sudo chmod +x /opt/bombardier-linux-amd64
    cd $pwd
}
